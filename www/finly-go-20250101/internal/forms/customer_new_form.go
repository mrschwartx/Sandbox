...
func (f *CustomerNewForm) Validate() error {
...
func (f *CustomerNewForm) validateRequiredFields() error {
	if f.Name == "" {
...
func (f *CustomerNewForm) validateEmail() error {
...
func (f *CustomerNewForm) validatePhone() error {
