...
const filter = () => {
    router.get('/dashboard/sales/filter', {
                                ...
                                <div class="card-body">
                                    ...
                                    <div v-if="sales">
                                        ...
                                        <div class="export text-end mb-3">
                                            <a :href="`/dashboard/sales/export?start_date=${start_date}&end_date=${end_date}`"
                                                target="_blank" class="btn btn-success btn-md border-0 shadow me-3"><i
                                                    class="fa fa-file-excel"></i> EXCEL</a>
                                            <a :href="`/dashboard/sales/pdf?start_date=${start_date}&end_date=${end_date}`"
