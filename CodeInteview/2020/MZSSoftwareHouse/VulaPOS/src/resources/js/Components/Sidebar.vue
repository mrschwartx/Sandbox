    ...
    <ul class="c-sidebar-nav">
        ...
        <li class="c-sidebar-nav-item">
            <Link class="c-sidebar-nav-link" v-if="hasAnyPermission(['dashboard.index'])"
                :class="{ 'active': $page.url.startsWith('/dashboard') }" href="/dashboard">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['transactions.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/transactions"
        ...
        <li class="c-sidebar-nav-title" v-if="hasAnyPermission(['sales.index']) || hasAnyPermission(['profits.index'])">
            REPORTS</li>

        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['sales.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/sales"
                :class="{ 'active': $page.url.startsWith('/dashboard/sales') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['profits.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/profits"
                :class="{ 'active': $page.url.startsWith('/dashboard/profits') }">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <li class="c-sidebar-nav-title"
            v-if="hasAnyPermission(['categories.index']) || hasAnyPermission(['products.index'])">MASTER</li>

        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['categories.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/categories"
                :class="{ 'active': $page.url.startsWith('/dashboard/categories') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['products.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/products"
                :class="{ 'active': $page.url.startsWith('/dashboard/products') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['customers.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/customers"
                :class="{ 'active': $page.url.startsWith('/dashboard/customers') }">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['users.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/users"
                :class="{ 'active': $page.url.startsWith('/dashboard/users') }">
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['roles.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/roles"
                :class="{ 'active': $page.url.startsWith('/dashboard/roles') }">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <li class="c-sidebar-nav-item" v-if="hasAnyPermission(['permissions.index'])">
            <Link class="c-sidebar-nav-link" href="/dashboard/permissions"
                :class="{ 'active': $page.url.startsWith('/dashboard/permissions') }">
