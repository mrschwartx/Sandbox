...
const onSubmit = () => {
    form.put(`/dashboard/products/${props.product.id}`, form, {
        onSuccess: () => {
            Swal.fire({
                title: 'Success!',
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 rounded-3 shadow border-top-purple">
                                <div class="card-header">
                                    <span class="font-weight-bold"><i class="fa fa-shopping-bag"></i> EDIT
                                        PRODUCT</span>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" v-model="form.barcode"
                                                        :class="{ 'is-invalid': errors.barcode }" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" v-model="form.title"
                                                        :class="{ 'is-invalid': errors.title }" type="text"
