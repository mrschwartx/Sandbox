...
func (s Service) ListCourse(ctx context.Context, req *v1.ListCoursesParam) ([]Course, string, error) {
	opts := []ListOption{
...
func (s Service) GetCourse(ctx context.Context, req *v1.GetCourseParam) (*Course, error) {
