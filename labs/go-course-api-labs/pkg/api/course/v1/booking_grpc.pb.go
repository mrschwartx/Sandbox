...
const (
	BookingService_ListBookings_FullMethodName   = "/example.com.course.v1.BookingService/ListBookings"
	BookingService_CreateBooking_FullMethodName  = "/example.com.course.v1.BookingService/CreateBooking"
	BookingService_GetBooking_FullMethodName     = "/example.com.course.v1.BookingService/GetBooking"
	BookingService_ReserveBooking_FullMethodName = "/example.com.course.v1.BookingService/ReserveBooking"
	BookingService_ExpireBooking_FullMethodName  = "/example.com.course.v1.BookingService/ExpireBooking"
)
...
type BookingServiceClient interface {
	...
	CreateBooking(ctx context.Context, in *CreateBookingParam, opts ...grpc.CallOption) (*Booking, error)
	GetBooking(ctx context.Context, in *GetBookingParam, opts ...grpc.CallOption) (*Booking, error)
...
func (c *bookingServiceClient) CreateBooking(ctx context.Context, in *CreateBookingParam, opts ...grpc.CallOption) (*Booking, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Booking)
...
func (c *bookingServiceClient) GetBooking(ctx context.Context, in *GetBookingParam, opts ...grpc.CallOption) (*Booking, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Booking)
...
type BookingServiceServer interface {
	...
	CreateBooking(context.Context, *CreateBookingParam) (*Booking, error)
	GetBooking(context.Context, *GetBookingParam) (*Booking, error)
...
func (UnimplementedBookingServiceServer) CreateBooking(context.Context, *CreateBookingParam) (*Booking, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBooking not implemented")
}
func (UnimplementedBookingServiceServer) GetBooking(context.Context, *GetBookingParam) (*Booking, error) {
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.com.course.v1.BookingService",
	...
	Metadata: "pkg/api/course/v1/booking.proto",
}
